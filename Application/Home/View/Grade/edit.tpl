...
<div class="page">
    <div class="pageContent">
        ...
        <form method="post" action="__URL__/update/navTabId/Grade" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
            <div class="pageFormContent" layoutH="58">
                ...
                <div class="unit">
                    ...
                    <input type="text" class="required"  name="Grade_name" id="Grade_name" value="{$obj['Grade_name']}">
                </div>
                <div class="unit">
                    <label>年级介绍：</label>
                    <textarea name="Grade_intro" class="required" id="Grade_intro" cols="70" rows="10">{$obj['Grade_intro']}</textarea>
                </div>
                <div class="unit">
                    <label>所属学院：</label>
...
<script>
    loadSpecialty($('#Specialty_id'), "{$obj['College_id']}", function() {
