        ...
        <form onsubmit="return navTabSearch(this);" action="__URL__" method="post">
            <div class="searchBar">
                <ul class="searchContent">
                    <li>
                        <label>学院名称：</label>
                        <input type="text" name="College_name" value="{$_REQUEST.College_name}" class="medium" >
                    </li>
                </ul>
                <div class="subBar">
                    <ul>
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
                ...
                <li><a class="delete" href="__URL__/foreverdelete/id/{sid_node}/navTabId/College" target="ajaxTodo"  title="你确定要删除吗？" warn="请选择节点"><span>删除</span></a></li>
        ...
        <table class="list" width="100%" layoutH="116">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;" width="100">学院名称</th>
                    <th style="text-align: center;" width="100">学院简介</th>
            ...
            <volist id="vo" name="list">
                <tr target="sid_node" rel="{$vo['id']}">
                    ...
                    <td style="text-align: center;" >{$vo['College_intro']}</td>
