        ...
        <form onsubmit="return navTabSearch(this);" action="__URL__" method="post">
            <div class="searchBar">
                <ul class="searchContent">
                    <li>
                        <label>单位名称：</label>
                        <input type="text" name="Specialty_name" value="{$_REQUEST.Specialty_name}" class="medium" >
                    </li>
                </ul>
                <div class="subBar">
                    <ul>
    ...
    <div class="pageContent">
        <div class="panelBar">
            <ul class="toolBar">
                ...
                <li><a class="delete" href="__URL__/foreverdelete/id/{sid_node}/navTabId/Specialty" target="ajaxTodo"  title="你确定要删除吗？" warn="请选择节点"><span>删除</span></a></li>
        ...
        <table class="list" width="100%" layoutH="116">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;" width="100">单位名称</th>
                    <th style="text-align: center;" width="100">单位简介</th>
            ...
            <volist id="vo" name="list">
                <tr target="sid_node" rel="{$vo['id']}">
                    ...
                    <td style="text-align: center;" >{$vo['Specialty_intro']}</td>
